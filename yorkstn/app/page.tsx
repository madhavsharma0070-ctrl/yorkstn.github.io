    ...
    <>
        ...
        <div style={{background:'var(--b)',position:'relative',overflow:'hidden'}}>
          ...
          <div style={{position:'absolute',inset:0,display:'flex',flexDirection:'column',justifyContent:'flex-end',padding:'60px'}}>
            <div style={{display:'flex',flexDirection:'column',gap:'32px',marginBottom:'44px'}}>
              {[{n:'3rd',l:"India projected rank as global retail market by 2030"},{n:'Delhi NCR',l:"India largest luxury goods market — over 35% national share"},{n:'13%+',l:'India retail market CAGR 2025–2033 (IMARC Group)'}].map(s=>(
            ...
            <blockquote style={{borderLeft:'2px solid rgba(192,154,98,.33)',paddingLeft:'20px'}}>
              <p style={{fontFamily:'var(--fd)',fontSize:'18px',fontStyle:'italic',fontWeight:300,color:'rgba(240,232,224,.52)',lineHeight:1.6}}>Great brands do not fail in India because of product. They fail because of entry.</p>
      ...
      <section style={{padding:'72px 60px',display:'flex',justifyContent:'space-between',alignItems:'center',gap:'40px',flexWrap:'wrap'}}>
        <div>
          ...
          <h2 className="rv d1" style={{fontFamily:'var(--fd)',fontSize:'clamp(26px,3.5vw,46px)',fontWeight:300,color:'var(--b)',lineHeight:1.1,marginTop:'10px'}}>Tell us about your brand.<br/><em style={{fontStyle:'italic',color:'var(--bl)'}}>We will tell you what is possible.</em></h2>
        </div>
